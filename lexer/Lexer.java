...
public class Lexer {
  ...
  public Token newUtf16StringToken(String utf, int startPosition, int endPosition, int lineNumber){
    name = "Utf16";
    return new Token(
      lineNumber,
      startPosition,
  ...
  public Token newtimeStampToken(String time, int startPosition, int endPosition, int lineNumber){
    name = "time";
    return new Token(
      lineNumber,
      startPosition,
            ...
            if((ch <= 70 && ch >= 65) || (ch >= 97 && ch <= 102) || (ch >= 48 && ch <= 57)){
              ...
              while(utf.length() <= utfLength){
                ...
                if((ch <= 70 && ch >= 65) || (ch >= 97 && ch <= 102) || (ch >= 48 && ch <= 57)){
                  ...
                  return newUtf16StringToken(utf, startPosition, endPosition, lineNumber);
                }
              }
            } else {
              utf += ch;
